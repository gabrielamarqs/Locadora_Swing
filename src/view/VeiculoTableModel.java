...
public class VeiculoTableModel extends AbstractTableModel{
    // tenho que ser capaz de pegar o valor de várias células
    ...
    public VeiculoTableModel(ArrayList<Veiculo> alVeiculo) {
        // construtor recebe uma array list de veiculos
        this.listaVeiculos = alVeiculo;
        // e vai setar uma lista de veiculos que todos vão poder enxergar os atributos
    }
    
    @Override
    // vai sobrescrever o método
